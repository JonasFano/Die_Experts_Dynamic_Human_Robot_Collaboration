...
class StressDetector:
    last_heartrate = 0
    def __init__(self, window_size=60, baseline_rmssd=25, stress_rmssd_threshold=0.5, high_bpm_threshold=100):
        """
    ...
    def add_heart_rate(self, heart_rate):
        ...
        self.last_heartrate = heart_rate
    ...
    def get_safetylevel(self):
        rmssd = self.calculate_rmssd()
        return self.detect_stress(rmssd, self.last_heartrate)
    ...
    def detect_stress(self, rmssd, heart_rate):
        ...
        if rmssd > self.rmssd_threshold:
            return StressLevels.LOW.value
        elif rmssd > self.rmssd_threshold - 10: # 15
            return StressLevels.MEDIUM.value
        else:
            return StressLevels.HIGH.value
