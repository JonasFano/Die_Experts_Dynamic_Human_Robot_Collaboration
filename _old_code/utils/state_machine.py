...
>>>>>>> origin/new_components:_old_code/utils/state_machine.py
...
=======
        ...
        elif self.state == 1000: # Camera calibration state for checking fixture detection
                self._check_fixtures(fixture_results)
                self.fixture_checker.calibrate_depth(current_depth_frame)
