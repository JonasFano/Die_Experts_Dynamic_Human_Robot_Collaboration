...
#p1 = np.array([-0.68066618616650417, -0.1347854199496408, 0.50, -1.7173584058437448, 2.614817123624442, 0.015662793265223476, speed, velocity, blending_radius])
#home_pose = np.array([-0.14066618616650417, -0.1347854199496408, 0.50, -1.7173584058437448, 2.614817123624442, 0.015662793265223476,speed, velocity, blending_radius])
#positions = interpolate_joint_positions(home_pose, p1, num_points=5)
#rtde_c.moveL(positions)
